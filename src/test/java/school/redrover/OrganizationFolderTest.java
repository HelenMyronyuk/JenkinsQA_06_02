...
public class OrganizationFolderTest extends BaseTest {
    ...
    private static final String ORGANIZATION_FOLDER_NAME = "OrgFolder"+RandomStringUtils.randomAlphanumeric(7);
    private static final String ORGANIZATION_FOLDER_RENAMED = "OrgFolderNew"+RandomStringUtils.randomAlphanumeric(7);
    ...
    private static final String DISPLAY_NAME = "This is Display Name of Folder"+RandomStringUtils.randomAlphanumeric(7);
